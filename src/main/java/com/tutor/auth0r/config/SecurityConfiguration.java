...
import com.tutor.auth0r.security.*;
import com.tutor.auth0r.web.filter.SpaWebFilter;
        ...
        http
            ...
            .authorizeHttpRequests(
                ...
                authz
                    ...
                    .requestMatchers(mvc.pattern("/api/app-users/GetAllRecommend")).permitAll()
                    .requestMatchers(mvc.pattern("/api/tutors/GetCustom/*")).permitAll()
                    .requestMatchers(mvc.pattern("/api/app-users/GetCurrentAppUser")).permitAll()
                    ...
                    .requestMatchers(mvc.pattern("/api/app-users/SearchTutor/**")).permitAll()
                    .requestMatchers(mvc.pattern("/api/tutors/by-subject")).permitAll()
