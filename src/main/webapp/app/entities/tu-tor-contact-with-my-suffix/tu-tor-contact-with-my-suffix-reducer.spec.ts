...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './tu-tor-contact-with-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TUTORCONTACTWITH_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TUTORCONTACTWITH actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TUTORCONTACTWITH actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TUTORCONTACTWITH actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TUTORCONTACTWITH actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TUTORCONTACTWITH actions', async () => {
      const arg = 42666;
