...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './hiring-hours-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HIRINGHOURS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HIRINGHOURS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HIRINGHOURS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_HIRINGHOURS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_HIRINGHOURS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HIRINGHOURS actions', async () => {
      const arg = 42666;
