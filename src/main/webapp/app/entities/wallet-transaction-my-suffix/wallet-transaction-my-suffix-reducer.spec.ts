...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './wallet-transaction-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WALLETTRANSACTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WALLETTRANSACTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WALLETTRANSACTION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_WALLETTRANSACTION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_WALLETTRANSACTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_WALLETTRANSACTION actions', async () => {
      const arg = 42666;
