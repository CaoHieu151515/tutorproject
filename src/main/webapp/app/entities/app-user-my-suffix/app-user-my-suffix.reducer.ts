...
export const getEntities = createAsyncThunk('appUser/fetch_entity_list', async ({ sort }: IQueryParams) => {
...
export const createEntity = createAsyncThunk(
  ...
  async (entity: IAppUserMySuffix, thunkAPI) => {
    const result = await axios.post<IAppUserMySuffix>(apiUrl, cleanEntity(entity));
...
export const updateEntity = createAsyncThunk(
  ...
  async (entity: IAppUserMySuffix, thunkAPI) => {
    const result = await axios.put<IAppUserMySuffix>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError },
...
export const partialUpdateEntity = createAsyncThunk(
  ...
  async (entity: IAppUserMySuffix, thunkAPI) => {
    const result = await axios.patch<IAppUserMySuffix>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError },
...
export const deleteEntity = createAsyncThunk(
  ...
  async (id: string | number, thunkAPI) => {
    const requestUrl = `${apiUrl}/${id}`;
    const result = await axios.delete<IAppUserMySuffix>(requestUrl);
    thunkAPI.dispatch(getEntities({}));
    return result;
  },
  { serializeError: serializeAxiosError },
