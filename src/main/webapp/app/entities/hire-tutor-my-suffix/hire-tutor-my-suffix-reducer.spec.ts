...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './hire-tutor-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HIRETUTOR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HIRETUTOR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HIRETUTOR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_HIRETUTOR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_HIRETUTOR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HIRETUTOR actions', async () => {
      const arg = 42666;
