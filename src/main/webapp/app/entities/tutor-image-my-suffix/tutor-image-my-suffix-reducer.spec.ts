...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './tutor-image-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TUTORIMAGE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TUTORIMAGE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TUTORIMAGE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TUTORIMAGE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TUTORIMAGE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TUTORIMAGE actions', async () => {
      const arg = 42666;
