...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FOLLOW_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FOLLOW actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FOLLOW actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_FOLLOW actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_FOLLOW actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FOLLOW actions', async () => {
      const arg = 42666;
