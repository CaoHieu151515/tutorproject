...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './tutor-details-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TUTORDETAILS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TUTORDETAILS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TUTORDETAILS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TUTORDETAILS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TUTORDETAILS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TUTORDETAILS actions', async () => {
      const arg = 42666;
