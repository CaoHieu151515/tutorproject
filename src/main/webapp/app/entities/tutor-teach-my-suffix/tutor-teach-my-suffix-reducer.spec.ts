...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './tutor-teach-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TUTORTEACH_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TUTORTEACH actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TUTORTEACH actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TUTORTEACH actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TUTORTEACH actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TUTORTEACH actions', async () => {
      const arg = 42666;
