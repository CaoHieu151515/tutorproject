...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './identity-card-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_IDENTITYCARD_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_IDENTITYCARD actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_IDENTITYCARD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_IDENTITYCARD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_IDENTITYCARD actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_IDENTITYCARD actions', async () => {
      const arg = 42666;
