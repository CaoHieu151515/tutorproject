...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './third-party-transaction-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_THIRDPARTYTRANSACTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_THIRDPARTYTRANSACTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_THIRDPARTYTRANSACTION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_THIRDPARTYTRANSACTION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_THIRDPARTYTRANSACTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_THIRDPARTYTRANSACTION actions', async () => {
      const arg = 42666;
