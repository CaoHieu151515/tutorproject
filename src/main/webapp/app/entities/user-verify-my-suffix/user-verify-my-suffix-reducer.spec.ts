...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './user-verify-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERVERIFY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_USERVERIFY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_USERVERIFY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_USERVERIFY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_USERVERIFY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_USERVERIFY actions', async () => {
      const arg = 42666;
