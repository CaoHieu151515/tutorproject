...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RATING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RATING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches PARTIAL_UPDATE_RATING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RATING actions', async () => {
      const arg = 42666;
