...
import { getEntity, deleteEntity } from './rating-my-suffix.reducer';

export const RatingMySuffixDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="projectApp.rating.delete.question">
        <Translate contentKey="projectApp.rating.delete.question" interpolate={{ id: ratingEntity.id }}>
...
export default RatingMySuffixDeleteDialog;
