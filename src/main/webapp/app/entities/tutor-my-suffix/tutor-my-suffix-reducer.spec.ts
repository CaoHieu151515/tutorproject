...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TUTOR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TUTOR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TUTOR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TUTOR actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TUTOR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TUTOR actions', async () => {
      const arg = 42666;
