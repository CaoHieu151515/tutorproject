...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './tutor-video-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TUTORVIDEO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TUTORVIDEO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TUTORVIDEO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TUTORVIDEO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TUTORVIDEO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TUTORVIDEO actions', async () => {
      const arg = 42666;
