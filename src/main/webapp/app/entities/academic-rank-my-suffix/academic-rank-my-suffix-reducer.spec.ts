...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './academic-rank-my-suffix.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACADEMICRANK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ACADEMICRANK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ACADEMICRANK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ACADEMICRANK actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ACADEMICRANK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ACADEMICRANK actions', async () => {
      const arg = 42666;
