...
public class FollowAsserts {
    ...
    public static void assertFollowUpdatableRelationshipsEquals(Follow expected, Follow actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getFollowerAppUser()).as("check followerAppUser").isEqualTo(actual.getFollowerAppUser()))
            .satisfies(e -> assertThat(e.getFollowedTutor()).as("check followedTutor").isEqualTo(actual.getFollowedTutor()));
    }
}
